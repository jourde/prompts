...
Rank the **top three** reliability risks (most severe first) with one-sentence justification each.

### D) Summary
Summarise your analysis in one paragraph.

#### E) Recommended tightened version

Provide a revised version of the Target Prompt that fixes the top risks while preserving intent.
---
