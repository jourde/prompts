...
11. **Summary:** Provide a brief prose summary of the analysis, indicating (a) whether the task would lend itself to a pedagogically supervised use of AI and (b) whether the novice/expert position makes such use prudent or risky — so as to inform the choice of track. If taxonomic anchoring has not been requested, indicate in one sentence that it remains available on request (revised Bloom or SOLO), without making it a condition.
